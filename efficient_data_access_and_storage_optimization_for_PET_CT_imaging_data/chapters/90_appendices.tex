...
\begin{itemize}
\item root entry points such as \path{process_dicom.py}, \path{extract_one_per_series.py}, and \path{webui.py},
\item reusable application modules under \path{dicom_browser/},
\item the automated test suite under \path{tests/},
\item CI workflow definitions under \path{.github/workflows/}.
\item the thesis report sources and generated document under \path{efficient_data_access_and_storage_optimization_for_PET_CT_imaging_data/}.
\end{itemize}
